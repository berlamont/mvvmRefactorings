...
{
    [ExportCodeRefactoringProvider(LanguageNames.CSharp, Name = nameof(vmGeneratorCodeRefactoringProvider)), Shared]
    internal class vmGeneratorCodeRefactoringProvider : CodeRefactoringProvider
    {
